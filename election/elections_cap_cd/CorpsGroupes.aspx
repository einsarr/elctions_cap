...
<asp:Content ID="Contenu" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
     ...
     <div class="col-md-12">
        <div class="table-responsive col-md-6">
            <asp:GridView ID="GridView1" CssClass="table table-bordered table-striped" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID_CORPS_GROUPE" DataSourceID="SqlDataSource1">
                <Columns>
                    <asp:BoundField DataField="ID_CORPS_GROUPE" HeaderText="ID_CORPS_GROUPE" ReadOnly="True" SortExpression="ID_CORPS_GROUPE" />
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FUPConnectionString %>" SelectCommand="SELECT * FROM [ELECTION_CAP_CORPS_GROUPE]"></asp:SqlDataSource>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <asp:TextBox ID="TXT_LIBELLE_CORPS_GROUPE" runat="server" placeholder="LIBELLE" class="form-control"></asp:TextBox>
                 </div>
            </div>
            <div class="modal-footer">
            <asp:Button ID="btn_add_corps_groupe" runat="server" CssClass="btn btn-primary" Text="Enregistrer" Width="146px" TabIndex="1" Enabled="true"/><br />
            </div>
        </div>
        </div>
    </div>
