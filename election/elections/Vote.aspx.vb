...
Partial Class elections_Candidat
    ...
    Protected Sub DataList1_ItemCommand(source As Object, e As DataListCommandEventArgs) Handles DataList1.ItemCommand
        ...
        If fonctions.EnsDejaVote(1) = False Then
            ...
            Dim query As String = "INSERT INTO ELECTION_CAP_VOTE(ID_ENSEIGNANT,ID_CANDIDAT,ID_COLLEGE,IP_ENSEIGNANT,PAYS) VALUES (@ID_ENSEIGNANT,@ID_CANDIDAT,@ID_COLLEGE,@IP_ENSEIGNANT,@PAYS)"
            Dim con As New SqlConnection(connectionString)
            Dim cmd As New SqlCommand(query, con)
            cmd.Parameters.AddWithValue("@ID_ENSEIGNANT", testArray(0))
            cmd.Parameters.AddWithValue("@ID_CANDIDAT", testArray(1))
            cmd.Parameters.AddWithValue("@ID_COLLEGE", testArray(2))
