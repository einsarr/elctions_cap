                ...
                <div class="col-md-12">
                    ...
                    <div class="col-lg-6">
                        <asp:Panel ID="PanelCorrige" runat="server">
                            ...
                            Vérifie tes données et clique sur le lien <asp:HyperLink ID="HyperLink2" Font-Bold="true" runat="server" CssClass="text-left text-success" NavigateUrl="~/voeux/modifdonnees.aspx">MODFIER </asp:HyperLink> pour corriger  au besoin.<br />
...
ORDER BY LIBELLE_ORDRE_PREFERENCE">
                        ...
                        <div class="form-group">
                            <asp:DropDownList ID="DropIA" runat="server" AutoPostBack="True" DataSourceID="SqlIARegional" DataTextField="IA" DataValueField="code06" CssClass="form-control">
                            </asp:DropDownList>
