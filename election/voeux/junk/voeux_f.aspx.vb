...
Partial Class candidature_voeux_f
	...
	Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
		...
		'Si le grid des resultats n'est pas vide on affiche les résultats et on cache les demande
		If Me.GridPostesDemandeResultat.Rows.Count <> 0 Then
			Me.GridPostesDemandes.Visible = False
			Me.GridPostesDemandeResultat.Visible = True
			Me.GridPostesDemandeResultat.DataBind()
