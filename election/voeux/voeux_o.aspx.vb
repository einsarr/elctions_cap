...
"From FUP_MOUVEMENT INNER Join " &
    ...
    Protected Sub GridViewDossierNum_DataBound(sender As Object, e As EventArgs) Handles GridViewDossierNum.DataBound
        ...
        If Me.GridViewDossierNum.PageCount > 0 Then
            ...
            Me.LabelDepot.Text = "Tu dois déposer ta fiche de vœux avec les justificatifs au niveau de ton inspection avant le <b class=""text-warning"">" & dateCloture.AddDays(1).ToString("D") & " à 12h</b>. La commission locale procédera à la validation de ta candidature au mouvement national."
        End If
